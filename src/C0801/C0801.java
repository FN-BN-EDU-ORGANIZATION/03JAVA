...
가장 많은 표를 받은 후보의 번호를 return 하는 메소드입니다.
 ...
 */
public class C0801 {
    public int[] C0801_sol(int N, int[] votes) {
    ...
    public static void main(String[] args) {
        ...
        int[] ret1 = sol.C0801_sol(N1, votes1);

        // Press Run button to receive output.
        System.out.println("Solution1: return value of the method is " + Arrays.toString(ret1) + " .");


        int N2 = 4;
        int[] votes2 = {1, 3, 2, 3, 2};
        int[] ret2 = sol.C0801_sol(N2, votes2);

        // Press Run button to receive output.
        System.out.println("Solution2: return value of the method is " + Arrays.toString(ret2) + " .");
    }
}
