...
public class C0802 {
    ...
    public int func(int record) {   //B가 지는 것을 냈을 경우 A의 값과 동일한 값으로 변경하여 리턴
        if (record == 0) return 1;
        else if (record == 1) return 2;
        return 0;
    }

    public int solution_0802(int[] recordA, int[] recordB) {
        int cnt = 0;    //A의 위치
    ...
    public static void main(String[] args) {
        ...
        int ret = sol.solution_0802(recordA, recordB);
