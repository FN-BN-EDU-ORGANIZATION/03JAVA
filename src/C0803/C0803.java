...
public class C0803 {
    int solution(int[] prices){
        ...
        for(int price : prices){
            ...
            //prices1 일때 price=1 : tmp=1 / price=2 : answer=1 / price=3 : answer=2
            //prices2 일때 price=3 : tmp=3 / price=1 : answer=-2
//                answer = Math.max(answer, tmp - price);
//prices1 일때  price=1 : tmp=1 / price=2: answer=-1 / price=3 : answer=-1
