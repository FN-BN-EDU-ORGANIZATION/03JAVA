...
*/
//위 그림은 타입과 float타입의 표현형식을 비교한 것인데,int타입은 '부호와 값',두 부분으로 이루어져있지만,
...
//연산속도의 향상이나 메모리를 절약하려면 float를 선택하고,더 큰 값의 범위라던가 더 높은 정밀도를 필요로 한다면
//double을 선택해야 한다.
/*
public class Ch04실수형{
	 public static void main(String[] args) {
		 
		float  f   =  9.12345678901234567890f;
		float  f2  =  1.234567890123456790f;
